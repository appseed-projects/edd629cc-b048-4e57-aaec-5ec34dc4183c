...
- Timestamp: `2022-05-11 17:08`
- Build ID: `edd629cc-b048-4e57-aaec-5ec34dc4183c`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/edd629cc-b048-4e57-aaec-5ec34dc4183c.git
$ cd edd629cc-b048-4e57-aaec-5ec34dc4183c
```
